...
- 例子：
  ```c++
    ...
    auto g = bind(show, a, b, placeholders::_2, d, placeholders::_1);
...
### 5类迭代器
- 算法要求的迭代器操作可以分为5个迭代器类别，C++标准指定了泛型和数值算法的每个迭代器的最小类别
- `vector<int>::iterator`迭代器是随机访问迭代器？
| 迭代器类别 | 解释 | 支持的操作|
|-----|-----|-----|
